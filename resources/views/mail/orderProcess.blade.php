    ...
    <div style="max-width: 1100px; margin: 0 auto; padding: 0 200px ; width: 65%;">
        ...
        <div style="background: white; padding: 5% 20% ; color: #333; font-size: 1.0em;">
            <div style="font-size: 1.0em;">
                ...
                <h1 style="text-align: center;">Order Processing</h1>
                <p>Dear {{ $name }},</p>
                <p>We are delighted to inform you that your order has officially entered the production phase. This
                    marks a significant step towards realizing your vision. Our team is diligently working to ensure
                    quality and precision at every stage of the process.</p>
                <br>
                <h2>Order Details:</h2>
                <ul>
