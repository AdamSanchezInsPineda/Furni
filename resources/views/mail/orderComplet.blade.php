    ...
    <div style="max-width: 1100px; margin: 0 auto; padding: 0 200px ; width: 65%;">
        ...
        <div style="background: white; padding: 5% 20% ; color: #333; font-size: 1.0em;">
            <div style="font-size: 1.0em;">
                ...
                <p>Dear {{ $name }},</p>
                <p>We are delighted to inform you that your order has been completed successfully. We hope that our
                    product(s) will meet your expectations and we look forward to serving you again in the future.</p>
                <br>
                <h2>Order Details:</h2>
                <ul>
